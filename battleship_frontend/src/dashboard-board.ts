...
export class DashboardBoard {
  ...
  moveUpdateChanged(moveResponseEvent: MoveResponseEvent, oldValue: MoveResponseEvent){
      if(moveResponseEvent!=null){
        ...
        this.dropMissile(moveResponseEvent.playerBoard,moveResponseEvent.move.y,this.gameParams.gameboardDimensions-1-moveResponseEvent.move.x,90,0xffffff,moveResponseEvent.moveResult=='empty'?'miss':'hit');
      }
  }
